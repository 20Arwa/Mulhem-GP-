...
def add_stories(app, db):
    stories = [
        ...
        },
        {
            "title": "الصديق الجديد ",
            "content": [
                  "في قرية صغيرة محاطة بالأشجار الكثيفة، كان هناك أرنب صغير يدعى 'لولو'.\n كان لولو يحب اللعب والقفز بين الأشجار، ولكنه كان يشعر بالوحدة لأنه لم يكن لديه أصدقاء.",
                "في يوم من الأيام، وبينما كان لولو يستكشف الغابة، سمع صوتا غريبا قادما من خلف الشجيرات.\n اقترب بحذر ورأى سلحفاة صغيرة تبكي. قال لولو: 'مرحبا! لماذا تبكين؟' ردت السلحفاة الصغيرة'اسمي رنيم، وكنت ألعب، ولكنني ضللت عن عائلتي.\n فكر لولو وقال: \'لا تقلقي يا رنيم! سأساعدك في العثور على عائلتك.'",
                "بدأ الاثنان معا رحلة البحث. قفز فوق الجداول الصغيرة وتسلق الصخور المنخفضة.\n كان لولو يقفز هنا وهناك، بينما كانت رنيم تتحرك ببطء ولكن بثبات. وأثناء الرحلة، تعلما أشياء كثيرة عن بعضهما.\n أخبر لولو رنيم عن مغامراته في الغابة، بينما أخبرته رنيم عن حبها للنباتات المائية.",
                "بعد ساعات من البحث، سمعا صوتا ينادي: \n'رنيم! رنيم!' كان صوت أم السلحفاة. ركض الاثنان نحو الصوت، وكانت فرحة اللقاء كبيرة. قالت أم رنيم'شكرا لك يا لولو! أنت حقا صديق رائع.\n' شعرت رنيم بالسعادة وقالت:\n'هل يمكن أن نصبح أصدقاء دائمين يا لولو؟\' ابتسم لولو وقال:'بالطبع! الصديق وقت الضيق.'\n ومنذ ذلك اليوم، أصبح لولو ورنيم أفضل صديقين، يستكشفان الغابة معا ويتشاركان أجمل اللحظات."
            ],
            "imgSrc": "images/الصديق الجديد.jpeg",
            "audioSrc": [
                "audio/our_library/الصديق الجديد 1.mp3",
                "audio/our_library/الصديق الجديد 2.mp3",
                "audio/our_library/الصديق الجديد 3.mp3",
                "audio/our_library/الصديق الجديد 4.mp3"
            ]
        },
        {
            "title": "الفتى المخادع",
            "content":  [
                "في بلدة صغيرة، كان هناك فتى يُدعى “ماهر”، معروفٌ بخداعه ومزاحه الثقيل مع أهل البلدة. في أحد الأيام، أثناء تجوله قرب النهر، عثر على جوهرة صغيرة لامعة. لم تكن الجوهرة ذات قيمة كبيرة، لكنها لفتت انتباهه وخطر في باله فكرة ليمزح مع الناس.عاد ماهر إلى السوق وصرخ بأعلى صوته:“لقد وجدت جوهرة ثمينة جدًا! إنها أغلى جوهرة في العالم!”اجتمع الناس حوله، يتسابقون لرؤية الجوهرة. لكنه أخفى الجوهرة في جيبه وقال:“لا يمكنني أن أريكم إياها الآن لكنها حقيقية!” بدأ الناس يتحدثون عن الجوهرة في كل مكان،وكان بعضهم مستعدًا \n",
                "لدفع المال لرؤيتها.استمتع ماهر بالموقف، لكنه لم يُظهر الجوهرة أبدًا,في اليوم التالي، قرر أن يرفع مستوى المزاح. ذهب إلى السوق مجددًا وصرخ:“لقد سرق أحدهم جوهرتي الثمينة! أرجوكم، ساعدوني في العثور عليها!”ركض أهل البلدة يبحثون في كل مكان، حتى أنهم تركوا أعمالهم ليبحثوا عن “الجوهرة المسروقة”.وعندما عادوا إليه وقالوا إنهم لم يجدوا شيئًا، ضحك وقال:“كنت أمزح فقط! لم تُسرق الجوهرة.”غضب أهل البلدة وقالوا:“أنت مخادع! لن نصدقك أبدًا!”بعد أيام قليلة، بينما كان ماهر يلعب قرب النهر رأى صيادًا عجوزًا يحمل \n",
                "جوهرة كبيرة حقًا، تبدو وكأنها من أغلى الكنوز.صرخ ماهر وركض إلى السوق قائلاً:“لقد وجدت جوهرة حقيقية، هذه المرة ضخمة وثمينة جدًا!”لكن هذه المرة، لم يهتم أحد لكلامه. قالوا له:“نحن نعرفك جيدًا. أنت تكذب دائمًا!” حاول ماهر إقناعهم، لكنه فشل. وفي النهاية، أُخذت الجوهرة الحقيقية إلى مكان آخر، ولم يصدق أحد أن ماهر كان صادقًا هذه المرة. \n"
            ], 
